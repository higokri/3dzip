...
if __name__ == '__main__':
    ...
    parser.add_argument('--pred-file', type=str, default='llava-3d-7b-scanqa_answer_val.json')
    parser.add_argument('--gt-file', type=str, default='playground/data/annotations/llava3d_scanqa_val_answer.json')
    ...
    val_scores = calc_scanqa_score(matched_preds, matched_gts, tokenizer, scorers)
    print()
